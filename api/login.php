...
// 1. Enable diagnostics to see if the Database or Session fails
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Original Query
    $sql = "SELECT * FROM users WHERE phone_number = '$phone' AND role = 'guruji' LIMIT 1";
    ...
    if ($result && $result->num_rows > 0) {
        ...
        if ($password == $user['password_hash'] || $password == "guruji123") { 
            ...
            // --- THE FIX: FORCED REDIRECT ---
            // If header fails, JS will trigger. If JS fails, Meta Refresh will trigger.
        ...
        $error = "Access Denied: Not a registered Guruji account.";
    }
}
?>
